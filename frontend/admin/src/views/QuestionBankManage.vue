<template>
  <div class="page">
    <el-card>
      ...
      <div class="filter">
        <el-select v-model="filterPositionId" placeholder="按岗位筛选" clearable style="width: 180px" @change="fetchList">
...
import type { PositionItem, QuestionBankItem } from '@/api/admin';
...
function openDialog(row?: QuestionBankItem) {
...
async function onDelete(row: QuestionBankItem) {
